...
intervals=99                                              ! Number of intervals for data recording.
...
if((replica.le.1).and.(supereplica.le.1))then                 ! gets the number of GRN files
  open(462,file='n_train_log.txt',action='write',iostat=ios)   ! only for 1st replicate but gives always the same
end if
