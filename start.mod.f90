...
p=1000                                                      ! number of individuals (must be an EVEN NUMBER !!!)
...
sdev=0.05                                                  ! standard deviation for the mutator algorithm
ss=0.3                                                   ! selection strenght
...
!!!!!!!!!!!!!!!!!!!! WARNING. MANUAL IMPLEMENTATION !!!!!!!!!!!!!!!!!!!!!!! WARNING. MANUAL IMPLEMENTATION !!!!!!!!
  ...
  if(i.eq.1)then
    block(1:2,1)=(/6,6/)                            ! target in Environment 1 (/trait1, trait2/)
    block(1:2,n)=(/6,6/)                            ! target in Environment 2 (/trait1, trait2/) ! Re-do for EF>1 !!! WARNING !!!!
